...
<!--        <button class="btn btn-outline-success" type="button">Main button</button>-->
        <ul class="nav navbar-nav">
            ...
            <li class=" dropdown" id="work">
                <a data-toggle="dropdown" href="#" class="dropdown-toggle">Статьи</a>
                <ul role="menu" class="dropdown-menu" id="dropdown-menu-work">
                    <li>  <?= Html::a('Список статей', ['/admin/article/index']) ?></li>
                    <li> <?= Html::a('Категории статей', ['/admin/category/index']) ?></li>
                    <li> <?= Html::a('Тэги статей', ['/admin/tag/index']) ?></li>
