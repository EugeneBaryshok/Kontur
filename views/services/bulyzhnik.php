...
use yii\helpers\Url;
$this->title = 'Купить булыжник в Санкт-Петербург';
...
<div class="proekt_top" style=" background: url(/img/stone_main_new.jpg) no-repeat  center fixed; background-size: cover;">
    ...
    <div class="jumbotron jumbotron-pages">
        <div class="container" style="text-align: left">
            <div class="col-md-10 col-lg-10 transp_block">
                <h1>Продажа булыжника в Санкт-Петербурге</h1>
				<p><br></p>
     ...
     <!-- <hr width="80%" size="1" color="#d3d3d3" align="center">-->
        ...
        <div class="row" style="margin-bottom: 30px">
            ...
            <div class="col-md-5 col-lg-5">
                <p style="font-size: 18px">Компания «Контур» предлагает купить булыжник для ландшафтного дизайна в Санкт-Петербурге по доступной цене. Все виды булыжного камня, представленного на нашем сайте, позволят подобрать необходимый материал для проведения дизайнерских работ и создания ландшафтных проектов.</p>
				
				<button class="purple_button signup"><img src="/img/proj_button.png">Заказать булыжник</button>

            </div>
            <div class="col-md-offset-1 col-md-5 col-lg-5" style="overflow: hidden;">

                <img src="/img/stones/bulyzhnik-1.jpg" height="350">
            </div>
		</div>
	</div>
</div>	
	...
	<div class="container ">		
		<div class="row">
			<div class="col-md-11 col-lg-11 ">
				<h2>Сланец</h2>
				<p><span class="green">Булыжник </span>– натуральный природный камень округлой правильной или разносторонней формы. Чаще всего это кварцит, базальт или диорит. Камни бывают разных размеров - от помещающихся в ладони, до размеров футбольного мяча. Встречаются и крупные булыжники – валуны, основу которых составляют метаморфические породы.</p>
				<div class="col-md-12 col-md-12	col-lg-12" style="overflow: hidden; margin-bottom:30px; margin-top:30px;">
					<img src="/img/stones/bulyzhnik-1.jpg" >
				</div>
				
				<p>Высокая прочность, практичность и универсальность, а также низкая стоимость булыжника сделали его основным камнем, который чаще всего применяется в создании ландшафтных проектов. Он придает приусадебному участку определенный аристократический вид, схожий с видом средневековых замков, а также способствует созданию атмосферы единения с природой.</p>
				
				<h2>Виды булыжника</h2>
				<p>В зависимости от цвета, состава и места происхождения выделяют следующие виды булыжника:</p>
				<ul>
				<li><strong>Розовый. </strong>Камень зернистой структуры с шероховатой поверхностью. Применяется в качестве облицовочного камня.</li>
				<li><strong>Бордовый. </strong>Гладкий камень средних размеров. Чаще всего используется в архитектурных и ландшафтных элементах, связанных с водой.</li>
				<li><strong>Кладочный. </strong>Основу камня составляет слоистый минерал, поэтому внешне булыжник получается полосатым.</li>
				<li><strong>Желтый уральский. </strong>Горный камень карамельного оттенка. Применяется в отделочных работах.</li>
				</ul>
				<h2>Сфера применения</h2>
				<p>Внешняя простота булыжника повышает степень его универсальности. Применение камню можно найти в любом проекте. Чаще всего булыжный камень используется в следующих дизайнерских решениях:</p>
				<ul>
				<li>Окантовка тропинок.</li>
				<li>Отделка цоколя здания.</li>
				<li>Устройство стенок бассейна.</li>
				<li>Создание экспозиции возле водоемов.</li>
				<li>Создание водопадов.</li>
				<li>Декор лестниц, заборов, стен.</li>
				<li>Создание каменных садов – альпинарий.</li>
				<li>Мощение дорожек.</li>
				</ul>
			
				<h2>Преимущества булыжника</h2>
				<ul>
				<li>Практичность и универсальность камня.</li>
				<li>Прочность и хорошая обрабатываемость.</li>
				<li>Низкая стоимость.</li>
				<li>Высокая твердость и малая упругость.</li>
				<li>Водонепроницаемость.</li>
				<li>Невосприимчивость к перепадам температуры окружающей среды и воздействию атмосферных осадков.</li>
				<li>Сочетаемость с другими природными камнями.</li>
				</ul>	
			</div>
		</div>
	</div>
...
<div class="price_div ">
		...
		<div class="container" style="text-align: center">
			<div class="row">
				<div class="col-md-12">
					<button class="purple_button signup"><img src="/img/proj_button.png">Вам перезвонить?!</button>
				</div>
			</div>
		</div>
</div>
...
<div class="price_div gray_block">
	...
	<div class="container" id="portfolio">
			<div class="row">
				<h2 style="margin-bottom: 30px"><span class="green">Примеры применения булыжника в ландшафтном дизайне дачного участка</span> фото</h2>
			</div>
	<p>
	Студия ландшафтного дизайна "Контур" предлагает полный спектр услуг начиная от проектирования заканчивая благоустройством и последующим сервисным обслуживанием. <br>
	</p>
...
<div class="additional_block " style="  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/img/stone_main_new.jpg) no-repeat center fixed;
    ...
    <div class="container" style="text-align: center">
        <div class="row">
            <div class="col-md-12">
               <button class="purple_button signup"><img src="/img/proj_button.png">Купить булыжник</button>
