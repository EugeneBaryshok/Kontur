...
use yii\helpers\Url;
$this->title = 'Купить камень лемезит в Санкт-Петербурге';
    ...
    <div class="jumbotron jumbotron-pages">
        <div class="container" style="text-align: left">
            <div class="col-md-10 col-lg-10 transp_block">
                <h1>Продажа лемезита в Санкт-Петербурге</h1>
				<p><br></p>
     ...
     <!-- <hr width="80%" size="1" color="#d3d3d3" align="center">-->
        ...
        <div class="row" style="margin-bottom: 30px">
            ...
            <div class="col-md-5 col-lg-5">
                <p style="font-size: 18px">Компания «Контур» предлагает купить лемезитные плиты в Санкт-Петербурге по доступной цене. Широкий ассортимент природного камня, представленного на нашем сайте, позволит подобрать необходимый материал для проведения дизайнерских работ и создания ландшафтных проектов.</p>
				
				<button class="purple_button signup"><img src="/img/proj_button.png">Заказать сланец</button>

            </div>
            <div class="col-md-offset-1 col-md-5 col-lg-5" style="overflow: hidden;">

                <img src="/img/stones/lemezit-1.jpg" height="350">
            </div>
		</div>
	</div>
</div>	
	...
	<div class="container ">		
		<div class="row">
			<div class="col-md-11 col-lg-11 ">
				<h2>Лемезит</h2>
				<p><span class="green">Лемезит </span>– натуральный камень мраморной группы, который содержит в своем составе известняковые породы, а также окаменелые останки водорослей и морских обитателей. По своей структуре камень однороден и тонкозернист. Лемезит добывается в России на Южном Урале, а называется так в честь реки Лемеза, которая протекает вблизи месторождения породы. Благодаря простоте в обработке, повышенной морозоустойчивости и влагонепрницаемости, плитняк лемезита применяется во всех видах строительных и отделочных работ, мощения, создания отдельных элементов ландшафтного дизайна.</p>
				
				<div class="col-md-12 col-md-12	col-lg-12" style="overflow: hidden; margin-bottom:30px; margin-top:30px;">
					<img src="/img/stones/lemezit-2.jpg" >
				</div>
				...
				<h2>Виды лемезита</h2>
				<p>Внешне натуральный лемезит – вишнево-бордовый по цвету, однако, могут встречаться и плитки другого оттенка, не сильно отличающегося от первоначального.</p>
				<p>В ландшафтном дизайне используется следующие виды лемезита:</p>
				<ul>
				<li>Колотый – используется как материал для облицовки подпорных стен, мощения пешеходных тропинок.</li>
				<li>Пиленый –применяется для постройки малых архитектурных объектов.</li>
				<li>Галтованный – камень, с помощью которого выкладываются пешеходные дорожки.</li>
				<li>«Горбушка» - применяется в качестве отделочного материала.</li>
				<li>Брусчатка – используется для мощения дорожек и площадок.</li>
				</ul>
				<h2>Сфера применения</h2>
				<p>Плитняк лемезита изготавливается разной толщины. Это дает возможность использовать его как в исключительно декоративных функциях, так и для мощения автомобильных стоянок и дорожек. Кроме того, лемезит применяется для:</p>
				<ul>
				<li>Отделки подпорных стен и заборов.</li>
				<li>Декоративного оформления водопадов и фонтанов.</li>
				<li>Выкладки и отсыпки дорожек.</li>
				<li>Наружной облицовки стен.</li>
				<li>Создания лестниц, каскадов и небольших архитектурных строений.</li>
				</ul>
				<h2>Преимущества лемезита</h2>
				<ul>
				<li>Оригинальный и неповторимый в красках внешний вид.</li>
				<li>Высокая прочность и долговечность камня.</li>
				<li>Натуральность происхождения и исключительные экологические свойства.</li>
				<li>Морозоустойчивость и влагонепроницаемость.</li>
				<li>Не выветривается и не выгорает под воздействием солнечных лучей.</li>
				<li>Доступность и низкая цена при оригинальности и неповторимости внешнего вида.</li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="price_div gray_block">
	...
	<div class="container" id="portfolio">
			<div class="row">
				<h2 style="margin-bottom: 30px"><span class="green">Примеры применения лемезита в ландшафтном дизайне дачного участка</span> фото</h2>
			</div>
	<p>
...
<div class="additional_block " style="  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/img/stone_main_new.jpg) no-repeat center fixed;
    ...
    <div class="container" style="text-align: center">
        <div class="row">
            <div class="col-md-12">
               <button class="purple_button signup"><img src="/img/proj_button.png">Купить лемезит</button>
