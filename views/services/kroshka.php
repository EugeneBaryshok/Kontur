...
use yii\helpers\Url;
$this->title = 'Купить декоративную каменную крошку в СПб';
    ...
    <div class="jumbotron jumbotron-pages">
        <div class="container" style="text-align: left">
            <div class="col-md-10 col-lg-10 transp_block">
                <h1>Продажа декоративной каменной крошки в Санкт-Петербурге</h1>
				<p><br></p>
     ...
     <!-- <hr width="80%" size="1" color="#d3d3d3" align="center">-->
        ...
        <div class="row" style="margin-bottom: 30px">
            ...
            <div class="col-md-5 col-lg-5">
                <p style="font-size: 18px">Компания «Контур» предлагает купить каменную крошку в Санкт-Петербурге по доступной цене. Все виды декоративной отсыпки, представленные на нашем сайте, позволят подобрать необходимый материал для проведения дизайнерских работ и создания ландшафтных проектов.</p>
				
				<button class="purple_button signup"><img src="/img/proj_button.png">Заказать каменную крошку</button>

            </div>
            <div class="col-md-offset-1 col-md-5 col-lg-5" style="overflow: hidden;">

                <img alt="каменная крошка в ландшафтном дизайне - фото" title="каменная крошка в ландшафтном дизайне" src="/img/stones/kroshka-1.jpg" height="350">
            </div>
		</div>
	</div>
</div>	
	...
	<div class="container ">		
		<div class="row">
			<div class="col-md-11 col-lg-11 ">
				<h2>Каменная крошка</h2>
				<p><span class="green">Декоративная крошка </span>представляет собой рассортированную по размерам фракций дробленные элементы природных камней. Главной особенностью декоративной отсыпки является сочетание в себе достоинств природных камней-источников и широкий диапазон возможного применения в ландшафтном проектировании. Кроме того, крошка может подвергаться дополнительной окраске или шлифовке, что существенно увеличивает варианты ее использования.</p>
		
				
				<div class="col-md-12 col-md-12	col-lg-12" style="overflow: hidden; margin-bottom:30px; margin-top:30px;">
					<img alt="каменная крошка в ландшафтном дизайне - фото" title="каменная крошка в ландшафтном дизайне" src="/img/stones/kroshka-2.jpg" >
				</div>
								
					
					<h2>Виды крошки</h2>
					<p>Декоративную крошку, которую применяют в ландшафтном дизайне можно разделить на следующие виды:</p>
					<ul>
					<li><strong>Гравий. </strong>Представляет собой мелкий округлые камешки. Бывает однородным или смешанным.</li>
					<li><strong>Щебень. </strong>Камень грубой формы, который получают в результате дробления больших природных пластов. Чаще всего используется мраморный или гранитный щебень.</li>
					<li><strong>Песок. </strong>Самая маленькая декоративная крошка, размер фракций которой не превышает 5 мм.</li>
					</ul>
					<h2>Сфера применения</h2>
					<ul>
					<li>Пешеходные тропинки.</li>
					<li>Комбинированные аллеи с более крупными камнями.</li>
					<li>Обсыпка клумб.</li>
					<li>Украшение дна водоемов, бассейнов или фонтанов.</li>
					</ul>
				
					<h2>Преимущества крошки</h2>
					<ul>
					<li>Естественно вписывается в различную дизайнерскую стилистку.</li>
					<li>Пластичность, сыпучесть материала и возможность использования в любых формах.</li>
					<li>Легкость перемещения и замены.</li>
					<li>Невосприимчивость к перепадам температуры и воздействию осадков.</li>
					<li>Неповторимые эстетические особенности, мягкость и особое звучание (мраморная крошка).</li>
					</ul>	
			</div>
		</div>
	</div>
...
<div class="price_div gray_block">
	...
	<div class="container" id="portfolio">
			<div class="row">
				<h2 style="margin-bottom: 30px"><span class="green">Примеры применения каменной крошки в ландшафтном дизайне дачного участка</span> фото</h2>
			</div>
	<p>
...
<div class="additional_block " style="  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/img/stone_main_new.jpg) no-repeat center fixed;
    ...
    <div class="container" style="text-align: center">
        <div class="row">
            <div class="col-md-12">
               <button class="purple_button signup"><img src="/img/proj_button.png">Купить крошку</button>
