...
$this->title = 'Прайс-лист на благоустройство';
...
<div class="ozelen_1">
    <div class="container ">
        ...
        <div class="row">
            <div class="col-md-offset-2 col-lg-offset-2 col-md-8 col-lg-8 col-sm-12 col-xs-12 orange_block">
                <h2 style="margin-bottom: 30px; font-size: 38px;">АКЦИИ</h1>
    ...
    <div class="container">
        ...
        <h1 style="margin-bottom: 30px; margin-top: 40px;"><span class="green">Прайс-лист на</span> работы по благоустройству:</h1>
        <!--<hr width="600" size="1" color="#d3d3d3" align="left">-->
        <div class="row">

            <div class="col-md-3 col-lg-3 col-sm-12" style="overflow: hidden">
                <img src="img/img_0017.jpg" style="height:860px">
            </div>
            <div class="col-md-9 col-lg-9" style="padding-left: 20px">

                <table class="proectirovanie" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                    <tr>
                        <th align="center">Виды работ</th>
                        <th align="center">Ед. <br>измер.</th>
                        <th valign="top" align="center">Цена, <br>руб.</th>
                        <th align="center">Примечание</th>
                    </tr>
                    <tr>
                        <td colspan="4" class="subtitle">Подготовительные работы</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4" class="subtitle">Работы по осушению и отводу воды</td>
                    </tr>
                    <tr>
...
<div class="ozelen_1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-12" style="overflow: hidden">
                <img src="img/img_0017.jpg" style="height:1160px">
            </div>
            <div class="col-md-9 col-lg-9" style="padding-left: 20px">
...
<div class="ozelen_1 gray_block">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-12" style="overflow: hidden">
                <!-- <img src="img/bl_price.jpg" style="height:646px"> -->
                <img src="img/img_0017.jpg" style="height:1400px">
            </div>
        </div>
    </div>
</div>
...
<div class="ozelen_1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-12" style="overflow: hidden">
                <img src="img/img_0017.jpg" style="height:900px">
            </div>
            <div class="col-md-9 col-lg-9" style="padding-left: 20px">
                ...
                <table class="proectirovanie" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>м.п.</td>
                        <td>от 400</td>
                        <td>В зависимости от конструкции и материвлов</td>
                    </tr>
                    <tr>
...
<div class="additional_block zabor_bg">
    <div class="container" style="text-align: center">
        <div class="row">

            <div class="col-md-12 ">
                <p style="">
                    После строительных мероприятий проводится <a href="ozelen.html" class="main_link" style="">
                        озеленение</a>. Посадка крупномерных деревьев,
